...
def main():
    ...
    # """ モデルの作成単位に分割する """
    # value = 0.5
    # # x_yes = x[(x['code_byo_578_now'] > value)]
    # x_yes = x[(x['a_kiou_exist'] > value) | (x['b_kiou_exist'] > value)]
    ...
    # # x_no = x[(x['code_byo_578_now'] <= value)]
    # x_no = x[(x['a_kiou_exist'] <= value) & (x['b_kiou_exist'] <= value)]
    ...
    # y_yes.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\y_yes.csv')
    ...
    # y_no.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\y_no.csv')
    # x_yes.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\x_yes.csv')
    ...
    # x_no.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\x_no.csv')
    # exit()
    #
    ...
    # clf = RandomForestClassifier(random_state=0, n_estimators=300, min_samples_leaf=5)
    ...
    # print('開始')
    # params = {'n_estimators': [10, 25, 50, 100, 300, 500],
    #           'max_depth': [9, 12, 15, 18, 25, 50, 100, None],
    ...
    # x_train.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\x_train_100.csv', index_col=0)
    # x_test.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\x_test_100.csv', index_col=0)
    # y_train.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\y_train.csv', index_col=0)
    # y_test.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\y_test.csv', index_col=0)
    ...
    # clf = RandomForestClassifier(random_state=0, n_estimators=2000, min_samples_leaf=1)
    #
    # clf.fit(x_train, y_train)
    ...
    # # path_train.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\path_train.csv')
    # # path_test.to_csv(r'C:\Users\tie303957\PycharmProjects\Ai_suggest\output\model\all\path_test.csv')
